        ...
        <div className="text-center pt-4 border-t border-bmhw-gold/20">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-gray-400 text-xs">
              Developed by{' '}
              <a
                href="https://alexnorth.ca/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-bmhw-gold transition-colors duration-300"
              >
                AlexNorth Digital — Mahmoud Ibrahim
              </a>
            </span>
            <a
              href="https://www.linkedin.com/in/mahmoud3ibrahim/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-bmhw-gold transition-colors duration-300"
              aria-label="LinkedIn"
